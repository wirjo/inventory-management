export default {
  ...
  restocking: {
    title: 'Restocking',
    description: 'Recommend and order items to restock based on demand forecast',
    budget: {
      title: 'Budget',
      max: 'Max: {amount} (full recommended restock)'
    },
    recommendations: 'Recommended Items',
    noRecommendations: 'No items need restocking right now',
